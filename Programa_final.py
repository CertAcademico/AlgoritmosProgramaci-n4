# Programa simplificado para saber la declaracion de renta
# Autor: Juan Pablo Quintana Ibañez

print("Hola este programa te ayuda a conocer si tienes que pagar declaracion de renta, y en el caso de que lo tengas "
      "que hacer cuanto es lo que deberas pagar.")

# Peticion inicial de datos al usuario
...
# Si el usuario o la contraseña son invalidas imprimir mensaje y salir del programa
if not (user1 in valid_user and pass1 in valid_pass):
...
# Si la persona es asalariada o extranjera imprimir mensaje y salir del programa
if asal == "1" and (fuera == "1" or "2"):
    print("Usted no debe presentar declaracion de renta")
    exit()

print("Ahora se le preguntaran algunos de sus topes.")
topbrut = input("Su patrimonio bruto supero en 2023 los 190.854.000 millones de pesos si(1) no(2): ")
...
if topbrut or topingre or toptarjeta or topconsum or topbanco == "1":
    ...
    if pers == "1":
        print("Usted al ser una persona natural para declarar renta debera realizar el cuestionario 210 de la "
              "DIAN el cual encontrara en el siguiente link (https://acortar.link/mqHxCI)")
    else:
        print("Usted al ser una persona juridica para declarar renta debera realizar el cuestionario 110 de la "
              "DIAN el cual encontrara en el siguiente link (https://acortar.link/4sQPVO)")
else:
